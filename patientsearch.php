...
if(isset($_POST['patient_search_submit']))
{
  ...
  // $fname = $_POST['patient_fname']; // Get the first name from the form
  // $query = "select * from patreg where fname LIKE '%$fname%'";
  // $gender = $_POST['patient_lname'];
  // $query = "select * from patreg where lname LIKE '%$lname'";
  // $contact=$_POST['patient_contact'];
